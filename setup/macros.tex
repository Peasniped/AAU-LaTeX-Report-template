...
% myRef - Reference med angivelse af figur/tabel. Figur/Tabel er med stort begyndelsesbogstav
\newcommand{\myRef}[2]{\textit{{\MakeUppercase #1} \ref{#2}}}
% Use: "this can be seen in \myRef{figure}{fig:cool_graph}"
% Output: this can be seen in Figure 3.2

% myRefPage - Reference med angivelse af figur/tabel og sidetal. Figur/Tabel er med stort begyndelsesbogstav
\newcommand{\myRefPage}[2]{\textit{{\MakeUppercase #1} \ref{#2} on page \pageref{#2}}}
% Use: "this can be seen in \myRefPage{figure}{fig:cool_graph}"
