...
\input{sections/5.1- introduction.tex}
\input{sections/5.2- analysis.tex}
\input{sections/5.3- product}
\input{sections/5.4- test and validation}
\input{sections/5.5- conclusion.tex}
\printbibliography[heading=bibintoc, title=Bibliography]
\label{sections:6- bibliography}
\appendix
\input{sections/7.a- appendix A.tex}
\end{document}