...
\appendix
%NB: Kommandoen '\myAppendixPageNumbering' kaldes før indsættelsen af et appendix(bilag). Kommandoen nulstiller sidetallet og parameteren 'A-' definerer prefix på sidetallene, så side 11 i bilaget formateres som side 'A-11'. Kommandoen skal kaldes på ny før hvert bilag.
